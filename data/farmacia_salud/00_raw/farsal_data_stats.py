...
# Read data
df = pd.read_csv('data/farmacia_salud/farmacia_salud_transactions.csv')

# Ensure output directory exists and open file to capture prints
output_path = Path('data/farmacia_salud/farmacia_salud_stats.txt')
...
with output_path.open('w', encoding='utf-8') as out:
    with redirect_stdout(out):
        ...
        print(f"September allergy products vs other months")
